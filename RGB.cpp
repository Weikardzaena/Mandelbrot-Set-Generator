...
/*	CONVERT HSV TO RGB
//
//	This algorithm takes in the number of iterations it took to escape and interprets it as a hue in HSV space
//	converting it to the corresponding RGB representation (with max value). 
*/
		...
		for (unsigned int i = 0; i < pixelCount; ++i)
		{
			...
			*/
			if (escape.at(j).at(i))
			{
				...
				S = 1;//fabs((float)1 - (hue.at(j).at(i) % 1000) / 500);
